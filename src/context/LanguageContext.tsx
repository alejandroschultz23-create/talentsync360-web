...
const translations: Record<Language, Translations> = {
  en: {
    ...
    home: {
      ...
      heroTitle: 'Validated LATAM Talent with C1+ English and Human Screening.',
      heroSubtitle: 'Operational freedom in your time zone.',
  ...
  es: {
    ...
    home: {
      ...
      heroTitle: 'Talento LATAM validado con inglés C1+ y screening humano.',
      heroSubtitle: 'Liberación operativa en tu zona horaria.',
