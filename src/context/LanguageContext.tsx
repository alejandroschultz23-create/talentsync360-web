...
const translations: Record<Language, Translations> = {
  en: {
    ...
    home: {
      ...
      heroStat1Value: '72h',
      heroStat1Label: 'Shortlist Sprint',
      heroStat2Value: 'Human',
      heroStat2Label: 'Screening',
      heroStat3Value: 'Technical',
      heroStat3Label: 'Signals',
  ...
  es: {
    ...
    home: {
      ...
      heroStat1Value: '72h',
      heroStat1Label: 'Sprint de Shortlist',
      heroStat2Value: 'Screening',
      heroStat2Label: 'Humano',
      heroStat3Value: 'Señales',
      heroStat3Label: 'Técnicas',
