        ...
        <div className="max-w-4xl animate-fade-in-up">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-900/50 border border-slate-800 backdrop-blur-md mb-8">
            ...
            <span className="text-xs font-mono uppercase tracking-widest text-slate-400">
              Engine Status: High Velocity Intake Active
            </span>
          </div>

          <h1 className="text-hero leading-[1.1] mb-8 text-premium-gradient">
            Curated Nearshore <br />
            <span className="text-indigo-500">Shortlists in 72 Hours</span>
          </h1>

          <p className="text-lg text-slate-400 mb-12 max-w-2xl leading-relaxed">
            The TalentSync360 engine accelerates technical hiring. 
            Direct access to vetted LATAM engineers. 
            Technical validation, C1 English verification, and cultural alignment delivered in under 3 days.
          </p>
